  /* 
    ...
    Version 0.99  BY JMR
    version ESIX by Gaylord Lebrun and Medhi Brinis, based on the work
    perfomed during the ESIX 3A project.
    See their report in the document section of the GitHub
...
int GEARS[] = {30,50,70};       // Vitesse grosso-modo en charge, la vitesse 10 correspond à 3 km/h et c'est lineaire
