...
switch(u8Etat){
  ...
  case ETAT_AUGMENTE_PWM:   i16PWM=i16PWM+1;  break;
  case ETAT_DIMINUE_PWM:    i16PWM=i16PWM-1;  break;
  //-----------------------------------------------------------------------------
  // REGULATION en VITESSE, on realise un correcteur proportionnel 
  // PWM=K(Consigne-vitesse rotation roue)
  //-----------------------------------------------------------------------------
  case ETAT_REGULATION:  i16PWM=i16PWMTemp+( u16Consigne-u16VitesseVelo )/500; break;
