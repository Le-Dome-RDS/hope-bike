...
#define ETAT_VITESSE_ERREUR       4
 ...
 uint16_t         u16VitesseMedian[5];                      // tableau pour calculer la valeur médiane de la vitesse
 uint16_t         u16PedalierMedian[5];                      // tableau pour calculer la valeur médiane de la vitesse
 ...
 int              PEDAL=1;   // bPedalage=true si PEDAL=1 ;  
...
// Remplit un tableau first in last out
